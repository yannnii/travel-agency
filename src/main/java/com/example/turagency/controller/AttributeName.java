...
public class AttributeName {
    ...
    public static final String QUANTITY_TOURS = "quantitytours";
    ...
    public static final String UPLOAD_TARGET = "uploadtarget";
    ...
    public static final String CREATE_PASSPORT = "addpassport";
